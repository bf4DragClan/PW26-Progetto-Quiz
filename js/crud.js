...
class CRUDManager {
    ...
    async loadData(tab) {
        try {
            console.log('Loading data for tab:', tab); // DEBUG
            let data;
            switch (tab) {
                case 'quiz':
                    ...
                    break;
                case 'domanda':
                    const quizCodice = this.lastQuizCodice || 1;
                    data = await api.getDomande(quizCodice);
                    break;
                case 'risposta':
                    ...
                    break;
                case 'partecipazione':
                    data = await api.getPartecipazioni();
                    break;
